...
public class TicketRepository implements Repository<Integer, Ticket> {
    ...
    public Optional<Ticket> save(Ticket entity) {
        ...
        String sql = "INSERT INTO ticket (buyerName, numberOfSeats, purchaseDate, show_id) VALUES (?, ?, ?, ?)";
    ...
    public Optional<Ticket> update(Ticket entity) {
        ...
        String sql = "UPDATE ticket SET buyerName = ?, numberOfSeats = ?, purchaseDate = ?, show_id = ? WHERE id = ?";
